            ...
            <div className="main-content">
                    ...
                    <div className="card-header">
                        ...
                        <div className="chart-legend">
                            <span className="legend-item">
                                <span className="legend-dot hours"></span>
                                Study Hours
                            </span>
                            <span className="legend-item">
                                <span className="legend-dot resources"></span>
                                Resources Used
                            </span>
                        </div>
                    </div>
                ...
                <div className="dashboard-grid-layout">
                    ...
                    <div className="left-column">
                        ...
                        <div className="content-card">
                            <div className="card-header">
                                <h2>🎯 Learning Activity Distribution</h2>
                            </div>
                        ...
                        <div className="content-card">
                            <div className="card-header">
                                <h2>📅 Weekly Progress Comparison</h2>
                            </div>
                            <ResponsiveContainer width="100%" height={250}>
                            ...
                            <div className="chart-insight">
                                💡 You're up 28% compared to last month!
                            </div>
                        </div>
                        ...
                        <div className="content-card">
                            ...
                            <div className="quick-stats">
                                <div className="quick-stat-item">
                                    ...
                                    <span className="stat-value-small">127 hrs</span>
                                </div>
                                <div className="quick-stat-item">
                                    <span className="stat-label">Resources Shared</span>
                                    <span className="stat-value-small">15</span>
                                </div>
                                <div className="quick-stat-item">
                                    <span className="stat-label">Help Given</span>
                                    <span className="stat-value-small">23</span>
                                </div>
                                <div className="quick-stat-item">
                                    <span className="stat-label">Group Sessions</span>
                                    <span className="stat-value-small">18</span>
                                </div>
                                <div className="quick-stat-item">
                                    <span className="stat-label">Completion Rate</span>
                                    <span className="stat-value-small">92%</span>
                                </div>
                                <div className="quick-stat-item">
                                    <span className="stat-label">Peer Rating</span>
                                    <span className="stat-value-small">4.9/5</span>
                                </div>
                            </div>
                        </div>
                    </div>
