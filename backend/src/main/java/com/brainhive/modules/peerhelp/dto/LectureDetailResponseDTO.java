...
public class LectureDetailResponseDTO {
    ...
    private boolean attendedByCurrentUser;

    public static LectureDetailResponseDTO fromLecture(Lecture lecture) {
    ...
    public boolean isAttendedByCurrentUser() { return attendedByCurrentUser; }
    public void setAttendedByCurrentUser(boolean attendedByCurrentUser) { this.attendedByCurrentUser = attendedByCurrentUser; }
}
